 ...
 * @author ARNAB
 */
public class EncryptMsg extends JFrame implements ActionListener  {
    JFrame f1;
    ...
    public EncryptMsg()
    {
        f1 = new JFrame("Message Encryption");
	fopen = new JFileChooser();
        ...
        l1 = new JLabel(" Input Message from a .txt File : ");
	...
	button4.addActionListener(this);
        ...
        l3 = new JLabel("If you want to save encrypted Message in a file : ");
    ...
    public void actionPerformed(ActionEvent e) {
		...
		JOptionPane.showMessageDialog(null, "No File Select!!");
            ...
            EncryptionMsg e1 = new EncryptionMsg();
            String s = e1.encrypt(txt.getText(), password);
            txt.setText("");
            txt.setText(s);
	}
		...
		JOptionPane.showMessageDialog(null, "No File Name Entered!!");
            ...
            try {	
        	if (fsave.showSaveDialog(f1) == JFileChooser.APPROVE_OPTION) {
